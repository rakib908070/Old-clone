...
try:
    version = requests.get("https://raw.githubusercontent.com/rakib908070/Old-clone/Version.txt").text
except:
...
{G3}  \__ \ / // /   / __/ /  |/ / / /   
{G4} ___/ // // /___/ /___/ /|  / / /    
{G5}/____/___/_____/_____/_/ |_/ /_/  卝{R}𝐊{G1}𝐢{X}𝐥{M}𝐥{S}𝐞{Y}𝐑 ツ
{M}════════════════════════════════════════════════
{R}[{G1}𓇬{R}]{S} 𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑 {R}〆{S} 𝐒𝐀𝐉𝐈𝐁-⁴⁴⁴
